...
namespace ME::Core::Math
{
	...
	PMatrix3x3::PMatrix3x3(float32 scalar) noexcept :
	...
	PMatrix3x3 PMatrix3x3::Transpose() const
	{
		return PMatrix3x3(
			a11, a21, a31,
			a12, a22, a32,
	...
	PMatrix3x3 PMatrix3x3::Abs() const
	{
		return PMatrix3x3(
	...
	PMatrix3x3 PMatrix3x3::Adjoint() const
	{
		return PMatrix3x3(
	...
	PMatrix3x3 PMatrix3x3::Invert() const
	{
		float32 det = Determinant();
		if (abs(det) < 1e-6f)
			return PMatrix3x3(0.0f);
	...
	float32 PMatrix3x3::Determinant() const
	{
		return (a11 * a22 * a33 + a21 * a32 * a13 + a31 * a12 * a23)
			- (a13 * a22 * a31 + a23 * a32 * a11 + a33 * a12 * a21);
	}

	bool PMatrix3x3::operator==(const PMatrix3x3& other) const
	{
	...
	PMatrix3x3& PMatrix3x3::operator-=(const PMatrix3x3& other)
	{
	...
	PMatrix3x3 PMatrix3x3::operator-(const PMatrix3x3& other) const
	{
		return PMatrix3x3(
			a11 - other.a11, a12 - other.a12, a13 - other.a13,
			a21 - other.a21, a22 - other.a22, a23 - other.a23,
	...
	PMatrix3x3 PMatrix3x3::operator*(const float32& scalar) const
	{
		return PMatrix3x3(
	...
	PMatrix3x3& PMatrix3x3::operator*=(const int32& scalar)
	{
		return *this *= static_cast<float32>(scalar);
	}

	PMatrix3x3& PMatrix3x3::operator*=(const float32& scalar)
	{
		a11 *= scalar; a12 *= scalar; a13 *= scalar;
		a21 *= scalar; a22 *= scalar; a23 *= scalar;
		a31 *= scalar; a32 *= scalar; a33 *= scalar;
