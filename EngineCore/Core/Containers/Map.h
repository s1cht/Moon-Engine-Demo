...
namespace Pawn
{
	...
	{
	public:
		using DataType = typename _Map::DataType;
	...
	template<class Key, class T, SIZE_T initSize = 20, class allocator = Memory::Allocator<T>>
	class Map
	{
	public:
		using DataType = Pair<Key, T>;
	...
	public:
		...
		Map(const std::initializer_list<DataType>& other)
	...
	private:
		...
		template <class... val>
		Iterator PEmplace(MapIterator<Map> it, val&&... args)
		{
