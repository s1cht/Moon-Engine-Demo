...
namespace ME::Render
{
	class MEAPI VulkanTexture3D final : public Texture3D
	{
	public:
		VulkanTexture3D(const Texture3DSpecification& specification);
	...
	public:
		...
		inline ME::Core::Math::Resolution3D<uint32> GetResolution() const override { return m_Specification.Resolution; }
