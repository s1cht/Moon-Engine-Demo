...
namespace ME::Render
{
    ...
    VulkanTexture3D::VulkanTexture3D(const Texture3DSpecification& specification)
    ...
    void VulkanTexture3D::SetData(void* data, SIZE_T size)
    {
        UpdateImage(data, size);
    }

    void VulkanTexture3D::Bind(ME::Core::Memory::Reference<CommandBuffer> commandBuffer,
    ...
    VkResult VulkanTexture3D::CreateImage()
    {
        ...
        createInfo.extent.depth = m_Specification.Resolution.z;
    ...
    VkResult VulkanTexture3D::CreateImageView()
    {
        ...
        createInfo.viewType = m_Specification.CubeMapCount > 0 ? VK_IMAGE_VIEW_TYPE_CUBE : VK_IMAGE_VIEW_TYPE_3D;
    ...
    VkResult VulkanTexture3D::CreateSampler()
    {
    ...
    VkResult VulkanTexture3D::UpdateImage(void* data, SIZE_T size)
    {
